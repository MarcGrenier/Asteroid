package ca.qc.cvm.sqlite.model;
...
import ca.qc.cvm.sqlite.model.db.DatabaseHelper;
...
public class ModelUsager {
	...
	public long addUsager(Usager user){
		...
		//passe pas le id pck il est automatiquement généré à cause du autoincrement		
